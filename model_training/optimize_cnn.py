...
def objective(
    ...
    rmse = training_run(
        ...
        sample_size=trial.suggest_int('sample_size', 100, 1000, step=1),
        ...
        first_filter_set=trial.suggest_int('first_filter_set', 16, 80, step=1),
        second_filter_set=trial.suggest_int('second_filter_set', 16, 80, step=1),
        third_filter_set=trial.suggest_int('third_filter_set', 16, 80, step=1),
        ...
        dense_units=trial.suggest_int('dense_units', 1, 64, step=1),
        batch_size=trial.suggest_categorical('batch_size', [1, 2, 4]),
        steps=trial.suggest_int('steps', 1, 100, step=1),
        epochs=100
    )
