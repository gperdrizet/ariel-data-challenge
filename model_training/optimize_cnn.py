...
def objective(
    ...
    rmse = training_run(
        ...
        l1=trial.suggest_float('l_one', 1e-5, 1.0),
        l2=trial.suggest_float('l_two', 1e-5, 2.0),
        first_filter_set=trial.suggest_int('first_filter_set', 16, 128, step=1),
        second_filter_set=trial.suggest_int('second_filter_set', 16, 128, step=1),
        third_filter_set=trial.suggest_int('third_filter_set', 16, 128, step=1),
        ...
        dense_units=trial.suggest_int('first_dense_units', 8, 64, step=1),
